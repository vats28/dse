...
"use.strict";angular.module("utils.http_post",[]).factory("generic_http_post_service",["$http","$timeout",function(t,e){var p="http://tab.hmcl.biz/",_="dse_app_UAT/",r=Object.freeze({LOGIN:p+_+"login.php",GET_DISTRICT:p+_+"get_district.php",GET_TEHSIL:p+_+"get_tehsil.php",GET_VILLAGE:p+_+"get_village.php",BIKE_MAKE_MODEL:p+_+"bike_make_model.php",GET_DISTRICT_DATA:p+_+"get_district_data.php",GET_STATE_DATA:p+_+"get_state_data.php",LATLONG:p+_+"latlong.php",FETCH_CONTACT:p+_+"fetch_contact.php",SYNC_RECORDS:p+_+"syncRecords.php",SYNC_FOLLOW_UP:p+_+"sync_follow_up.php",GET_FOLLOW_UP:p+_+"get_follow_up.php",CHECK_VERSION:p+_+"check_version.php",FETCH_CAMPAIGN_DATA:p+_+"fetch_campaign_data.php"}),c={success:0,failure_title:"Error",failure_msg:"Something went wrong",error_code:101},o="punar",i=!1;return{getServices:function(){return r},getDetails:function(e,p,_){i=!0;var r={},o=CryptoJS.AES.encrypt(JSON.stringify(JSON.stringify(p)),"dse",{format:CryptoJSAesJson}).toString();r.data=o,t.post(e,r).success(function(t,e,p,r){i=!1;try{}catch(c){}_(t)}).error(function(t,e,p,r){i=!1,_(c)})},getDetails_httpget:function(e,p,_){i=!0,e+="?",e+="data="+rc4(o,"hello dsc"),t.get(e,{timeout:2e4}).success(function(t,e,p,r){i=!1,_(t)}).error(function(t,e,p,r){i=!1,_(c)})}}}]);
