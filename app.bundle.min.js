...
angular.module("starter.testride",[]).controller("testrideCtrl",["$scope","$timeout","date_picker","form_validator","generic_http_post_service",function(e,t,s,r,a){e.arrayList={},e.temp_data={},e.init=function(){e.fetch_test_ride()},e.fetch_test_ride=function(){e.showLoader(""),e.requestData={},e.requestData.user_id="sdgvcgsdv",e.requestData.enq_id=e.sessionVariable.selected_enquiry.ENQUIRY_ID,a.getDetails(a.getServices().FETCH_TEST_RIDE,e.requestData,e.fetch_test_ride_callback)},e.fetch_test_ride_callback=function(t){e.hideLoader(),1==t.success?e.arrayList=t:e.showAlertWindow_Titled("Error",t.respDescription,e.goBackScreen,null)},e.submit_test_ride=function(){for(e.showLoader(""),e.requestData={},e.requestData.user_id=e.sessionVariable.username,e.requestData.enq_id=e.sessionVariable.selected_enquiry.ENQUIRY_ID,e.requestData.dealer_id=e.sessionVariable.selected_enquiry.DEALER_BU_ID,e.ans={},i=0;i<e.arrayList.test_ride_ques.length;i++)e.temp_data[i+1]&&(e.ans[i+1]=e.temp_data[i+1]);e.requestData.ans=JSON.stringify(e.ans),a.getDetails(a.getServices().SYNC_TEST_RIDE,e.requestData,e.submit_test_ride_callback)},e.submit_test_ride_callback=function(t){e.hideLoader(),1==t.success?e.showAlertWindow_Titled("Success","Thanks test ride feedaback submited successfully",e.goBackScreen):e.showAlertWindow_Titled("Error",t.respDescription,null,null)}}]);
