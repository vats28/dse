...
angular.module("starter.emiCalc",[]).controller("emiCalcCtrl",["$scope","generic_http_post_service","fileTransfer","$ionicPlatform",function(t,e,m,n){window.addEventListener("native.keyboardshow",function(){document.getElementById("keyboardButton").style.display="",console.log("keyboard-open"+t.temp.isKeyboard)}),window.addEventListener("native.keyboardhide",function(){t.temp.isKeyboard=!1,document.getElementById("keyboardButton").style.display="none",console.log("keyboard-hide"+t.temp.isKeyboard)}),t.init=function(){t.temp={amount1:0,months1:0,rate1:0},document.getElementById("keyboardButton").style.display="none"},t.calculate=function(e){if(1==e?t.temp.amount=t.temp.amount1:2==e?t.temp.months=t.temp.months1:3==e?t.temp.rate=t.temp.rate1:4==e?t.temp.amount1=t.temp.amount:5==e?t.temp.months1=t.temp.months:6==e&&(t.temp.rate1=t.temp.rate),t.temp.amount&&t.temp.months&&t.temp.rate){var m=t.temp.amount,n=t.temp.months,a=t.temp.rate/1200;t.temp.calculated=(m*a/(1-Math.pow(1/(1+a),n))).toFixed(2),t.temp.total_interest=(t.temp.calculated*t.temp.months-t.temp.amount).toFixed(2),t.temp.amount_to_pay=(t.temp.calculated*t.temp.months).toFixed(2),t.createPieChart()}else;},t.onAdd=function(e){var m=5e5,n=84,a=30;t.temp.amount=parseInt(t.temp.amount),t.temp.amount1=parseInt(t.temp.amount1),t.temp.rate=parseInt(t.temp.rate),t.temp.rate1=parseInt(t.temp.rate1),t.temp.months=parseInt(t.temp.months),t.temp.months1=parseInt(t.temp.months1),1==e?(t.temp.amount=t.temp.amount1=t.temp.amount?t.temp.amount:0,t.temp.amount<m&&(t.temp.amount+=500,t.temp.amount1+=500,t.temp.amount>m&&(t.temp.amount=t.temp.amount1=m))):2==e?(t.temp.months=t.temp.months1=t.temp.months?t.temp.months:0,t.temp.months<n&&(t.temp.months+=1,t.temp.months1+=1,t.temp.months>n&&(t.temp.months=t.temp.months1=n))):3==e&&(t.temp.rate=t.temp.rate1=t.temp.rate?t.temp.rate:0,t.temp.rate<a&&(t.temp.rate+=1,t.temp.rate1+=1,t.temp.rate>a&&(t.temp.rate=t.temp.rate1=a))),t.calculate(1)},t.onMinus=function(e){t.temp.amount=parseInt(t.temp.amount),t.temp.amount1=parseInt(t.temp.amount1),t.temp.rate=parseInt(t.temp.rate),t.temp.rate1=parseInt(t.temp.rate1),t.temp.months=parseInt(t.temp.months),t.temp.months1=parseInt(t.temp.months1),1==e?t.temp.amount>0&&(t.temp.amount-=500,t.temp.amount1-=500,t.temp.amount<0&&(t.temp.amount=t.temp.amount1=0)):2==e?t.temp.months>0&&(t.temp.months-=1,t.temp.months1-=1,t.temp.months<0&&(t.temp.months=t.temp.months1=0)):3==e&&t.temp.rate>0&&(t.temp.rate-=1,t.temp.rate1-=1,t.temp.rate<0&&(t.temp.rate=t.temp.rate1=0)),t.calculate(1)},t.createPieChart=function(){var e={type:"doughnut",data:{datasets:[{data:[t.temp.total_interest,t.temp.amount],backgroundColor:["#FF0000","#000"],label:"Interest & EMI chart"}],labels:["Interest","Actual Amount"]},options:{responsive:!0,legend:{position:"top"},title:{display:!0,text:""},animation:{animateScale:!0,animateRotate:!0}}},m=document.getElementById("chart-area").getContext("2d");window.myDoughnut=new Chart(m,e)}}]);
angular.module("starter.editEnquiry",[]).controller("editEnquiryCtrl",["$scope","$timeout","date_picker","form_validator","generic_http_post_service",function(e,t,a,s,n){e.previous_selectedModel="",e.disableCase={ONE:!0,TWO:!1},e.veh_type_list=[{id:1,type:"Two Wheeler"},{id:2,type:"Four wheeler"},{id:3,type:"First Time Buyer"}],e.onTab1_click=function(){e.tabs_validation()&&(e.tab1=!0,e.tab2=!1,e.tab3=!1)},e.onTab2_click=function(){e.tabs_validation()&&(e.tab1=!1,e.tab2=!0,e.tab3=!1)},e.onTab3_click=function(){e.tabs_validation()&&(e.tab1=!1,e.tab2=!1,e.tab3=!0)},e.tabs_validation=function(){return e.tab1?e.tab1_validation():e.tab2?e.tab2_validation():e.tab3?e.tab3_validation():void 0},e.tab1_validation=function(){return e.sessionVariable.temp_cont_enq.EMAIL_ADDR&&!s.IsValidEmail(e.sessionVariable.temp_cont_enq.EMAIL_ADDR)?(e.showAlertWindow_Titled("Error","Please enter valid email address"),!1):e.sessionVariable.temp_cont_enq.AGE?e.sessionVariable.temp_cont_enq.GENDER?!0:(e.showAlertWindow_Titled("Error","Please select gender"),!1):(e.showAlertWindow_Titled("Error","Please enter age"),!1)},e.tab2_validation=function(){if(e.disableCase.TWO){if(!e.sessionVariable.temp_cont_enq.state_id)return e.showAlertWindow_Titled("Error","Please select state"),!1;if(!e.sessionVariable.temp_cont_enq.district_id)return e.showAlertWindow_Titled("Error","Please select district"),!1;if(!e.sessionVariable.temp_cont_enq.tehsil_id)return e.showAlertWindow_Titled("Error","Please select tehsil"),!1;if(!e.sessionVariable.temp_cont_enq.village_id)return e.showAlertWindow_Titled("Error","Please select village"),!1}return!0},e.tab3_validation=function(){if(!e.sessionVariable.temp_cont_enq.X_MODEL_INTERESTED)return e.showAlertWindow_Titled("Error","Please select a model"),!1;if(!e.sessionVariable.temp_cont_enq.FOLLOW_DATE)return e.showAlertWindow_Titled("Error","Please select a followup date"),!1;if(!e.sessionVariable.temp_cont_enq.existVeh)return e.showAlertWindow_Titled("Error","Please select existing vehical type"),!1;if(e.sessionVariable.temp_cont_enq.EXPCTD_DT_PURCHASE){var t=e.sessionVariable.temp_cont_enq.FOLLOW_DATE,i=e.sessionVariable.temp_cont_enq.EXPCTD_DT_PURCHASE;if(2==a.isGreaterDate(t,i))return e.showAlertWindow_Titled("Error","Followup date should be smaller then expected purchase date"),!1}return!0},e.toggleAddressEdit=function(){e.disableCase.TWO&&e.getStateList()},e.isExisitingEnquiry=!1,e.init=function(){e.previous_selectedModel=e.sessionVariable.temp_cont_enq.X_MODEL_INTERESTED,e.sessionVariable.createNewEnquiry?(e.tab3=!0,e.sessionVariable.createNewEnquiry=!1,e.isExisitingEnquiry=!0):e.tab1=!0,e.init_part2()},e.init_part2=function(){e.sessionVariable.temp_cont_enq={},e.sessionVariable.selected_enquiry_edit.EXPCTD_DT_PURCHASE=e.changeDateFormat(e.sessionVariable.selected_enquiry_edit.EXPCTD_DT_PURCHASE),e.sessionVariable.selected_enquiry_edit.FOLLOW_DATE=e.changeDateFormat(e.sessionVariable.selected_enquiry_edit.FOLLOW_DATE),e.sessionVariable.temp_cont_enq=e.sessionVariable.selected_enquiry_edit,e.sessionVariable.temp_cont_enq.AGE=parseInt(e.sessionVariable.selected_enquiry_edit.AGE),e.sessionVariable.temp_cont_enq.exchange_req="Y"==e.sessionVariable.temp_cont_enq.X_EXCHANGE_REQUIRED,e.sessionVariable.temp_cont_enq.finance_req="Y"==e.sessionVariable.temp_cont_enq.X_FINANCE_REQUIRED,e.sessionVariable.temp_cont_enq.test_ride="Y"==e.sessionVariable.temp_cont_enq.X_TEST_RIDE_REQ,e.getMakeModel()},e.getStateList=function(){var t=null;try{t=JSON.parse(e.GetInLocalStorage(e.localStorageKeys.STATE))}catch(i){console.log("stateData master not found  "+i)}t?(e.sessionVariable.temp_cont_enq.state_list=t.state,e.setState()):e.showAlertWindow_Titled("Error","State master not available")},e.setState=function(){e.sessionVariable.temp_cont_enq.state_id=e.getValueInJson(e.sessionVariable.temp_cont_enq.state_list,e.sessionVariable.temp_cont_enq.STATE,"state_name","id"),e.get_district(e.sessionVariable.temp_cont_enq.state_id,e.get_district_callback)},e.get_district_callback=function(t){e.hideLoader(),"true"==t.success?(e.sessionVariable.temp_cont_enq.district_list=t.district,e.setDistrict()):e.showAlertWindow_Titled("Error",t.respDescription,null,null)},e.setDistrict=function(){e.sessionVariable.temp_cont_enq.district_id=e.getValueInJson(e.sessionVariable.temp_cont_enq.district_list,e.sessionVariable.temp_cont_enq.DISTRICT,"district_name","id"),e.sessionVariable.temp_cont_enq.district_id&&e.get_full_district_data(e.sessionVariable.temp_cont_enq.district_id,e.get_full_district_data_callback)},e.get_full_district_data_callback=function(t){e.hideLoader(),t.result!=[]?(e.sessionVariable.temp_cont_enq.tehsil_list=t.tehsil,e.sessionVariable.temp_cont_enq.village_list=t.village,e.setTehsil(),e.setCity()):e.showAlertWindow_Titled("Error",t.respDescription,null,null)},e.setTehsil=function(){e.sessionVariable.temp_cont_enq.tehsil_id=e.getValueInJson(e.sessionVariable.temp_cont_enq.tehsil_list,e.sessionVariable.temp_cont_enq.TEHSIL,"tehsil_name","id")},e.setCity=function(){e.sessionVariable.temp_cont_enq.village_id=e.getValueInJson(e.sessionVariable.temp_cont_enq.village_list,e.sessionVariable.temp_cont_enq.CITY,"village_name","id")},e.onStateChange=function(){e.showConfirm("Are you sure","Do you really want to change your district?",null,e.onStateChange_callback)},e.onStateChange_callback=function(){e.sessionVariable.temp_cont_enq.district_id="",e.sessionVariable.temp_cont_enq.tehsil_id="",e.sessionVariable.temp_cont_enq.village_id="",e.get_district(e.sessionVariable.temp_cont_enq.state_id,e.get_district_callback)},e.onDistrictChange=function(){e.showConfirm("Are you sure","Do you really want to change your district?",null,e.onDistrictChange_callback)},e.onDistrictChange_callback=function(){e.sessionVariable.temp_cont_enq.tehsil_id="",e.sessionVariable.temp_cont_enq.village_id="",e.get_full_district_data(e.sessionVariable.temp_cont_enq.district_id,e.get_full_district_data_callback)},e.onTehsilChange=function(){e.sessionVariable.temp_cont_enq.village_id=""},e.getMakeModel=function(){var t=null;try{t=JSON.parse(e.GetInLocalStorage(e.localStorageKeys.MAKE_MODEL)),t?(e.sessionVariable.temp_cont_enq.make_list=t.make,e.sessionVariable.temp_cont_enq.model_list=t.model,e.sessionVariable.temp_cont_enq.model_interested=t.model_interested,e.setExistingVehicle()):e.showAlertWindow_Titled("Error","No data not found for make and model")}catch(i){console.log("make model not found  "+i),alert(i)}},e.setExistingVehicle=function(){e.sessionVariable.temp_cont_enq.existVeh=e.getValueInJson(e.veh_type_list,e.sessionVariable.selected_enquiry_edit.EXISTING_VEHICLE,"type","id"),e.setExistingMake()},e.setExistingMake=function(){e.sessionVariable.temp_cont_enq.existMake=e.getValueInJson(e.sessionVariable.temp_cont_enq.make_list,e.sessionVariable.selected_enquiry_edit.MAKE_CD,"make_name","id"),e.setExistingModel()},e.setExistingModel=function(){e.sessionVariable.temp_cont_enq.existModel=e.sessionVariable.selected_enquiry_edit.MODEL_CD},e.onExistVeh_Change=function(){e.sessionVariable.temp_cont_enq.existMake="",e.sessionVariable.temp_cont_enq.existModel=""},e.onExistMake_Change=function(){e.sessionVariable.temp_cont_enq.existModel=""},e.selectedModel="",e.pickDate=function(t){e.selectedModel=t,a.getDate("date",e.pickDate_callback,!1)},e.pickDate_callback=function(t){"exp"==e.selectedModel?e.sessionVariable.temp_cont_enq.EXPCTD_DT_PURCHASE=t.currDate:"fol"==e.selectedModel&&(e.sessionVariable.temp_cont_enq.FOLLOW_DATE=t.currDate)},e.getDateWithMonthName=function(e){if(e){var t="dd-mmm-yy";return a.getDateWithMonthName(e,t)}},e.getFolDateWithMonthName=function(t){if(!t){var i=a.addDays(new Date,3);t=a.convertDateToString(i,"yyyy-mm-dd"),e.sessionVariable.temp_cont_enq.FOLLOW_DATE=t}},e.changeDateFormat=function(e){if(e){var t=new Array("jan","feb","mar","apr","may","jun","jul","aug","sep","oct","nov","dec"),i=e.split("-");return e="20"+i[2]+"-"+padLeftZero(t.indexOf(i[1].toLowerCase())+1)+"-"+padLeftZero(i[0])}},e.saveTempEnquiry=function(){if(e.tab1_validation()&&e.tab2_validation()&&e.tab3_validation()){e.showLoader("Please wait..."),e.requestData={},e.requestData.mobile=e.sessionVariable.temp_cont_enq.CELL_PH_NUM,e.requestData.email=e.sessionVariable.temp_cont_enq.EMAIL_ADDR,e.requestData.fname=e.sessionVariable.temp_cont_enq.FST_NAME,e.requestData.lname=e.sessionVariable.temp_cont_enq.LAST_NAME,e.requestData.age=e.sessionVariable.temp_cont_enq.AGE,e.requestData.gender=e.sessionVariable.temp_cont_enq.GENDER,e.requestData.address1=e.sessionVariable.temp_cont_enq.ADDR,e.requestData.address2=e.sessionVariable.temp_cont_enq.ADDR_LINE_2,e.requestData.pincode=e.sessionVariable.temp_cont_enq.pincode,e.sessionVariable.selected_enquiry_edit.ENQUIRY_ID&&(e.requestData.exist_enq_id=e.sessionVariable.selected_enquiry_edit.ENQUIRY_ID),e.requestData.user_id=e.sessionVariable.username,e.disableCase.TWO?(e.requestData.state=e.getValueInJson(e.sessionVariable.temp_cont_enq.state_list,e.sessionVariable.temp_cont_enq.state_id,"id","state_name"),e.requestData.district=e.getValueInJson(e.sessionVariable.temp_cont_enq.district_list,e.sessionVariable.temp_cont_enq.district_id,"id","district_name"),e.requestData.tehsil=e.getValueInJson(e.sessionVariable.temp_cont_enq.tehsil_list,e.sessionVariable.temp_cont_enq.tehsil_id,"id","tehsil_name"),e.requestData.village=e.getValueInJson(e.sessionVariable.temp_cont_enq.village_list,e.sessionVariable.temp_cont_enq.village_id,"id","village_name")):(e.requestData.state=e.sessionVariable.selected_enquiry_edit.STATE,e.requestData.district=e.sessionVariable.selected_enquiry_edit.DISTRICT,e.requestData.tehsil=e.sessionVariable.selected_enquiry_edit.TEHSIL,e.requestData.village=e.sessionVariable.selected_enquiry_edit.CITY),e.requestData.exchange_req=e.sessionVariable.temp_cont_enq.exchange_req?"Y":"N",e.requestData.finance_req=e.sessionVariable.temp_cont_enq.finance_req?"Y":"N",e.requestData.test_ride=e.sessionVariable.temp_cont_enq.test_ride?"Y":"N",e.requestData.existVeh=e.getValueInJson(e.veh_type_list,e.sessionVariable.temp_cont_enq.existVeh,"id","type"),e.requestData.existMake=e.getValueInJson(e.sessionVariable.temp_cont_enq.make_list,e.sessionVariable.temp_cont_enq.existMake,"id","make_name"),null==e.sessionVariable.temp_cont_enq.existModel&&(e.sessionVariable.temp_cont_enq.existModel=""),e.requestData.existModel=e.sessionVariable.temp_cont_enq.existModel,e.requestData.model_interested=e.sessionVariable.temp_cont_enq.X_MODEL_INTERESTED;var t=e.sessionVariable.temp_cont_enq.FOLLOW_DATE,s=e.sessionVariable.temp_cont_enq.EXPCTD_DT_PURCHASE;e.requestData.fol_date=a.getDateInFormat(t,"mm/dd/yyyy"),e.requestData.exp_purchase_date=a.getDateInFormat(s,"mm/dd/yyyy"),e.requestData.dealer_code=e.sessionVariable.login_data.dealer_code;var o=1;for(i=0;i<e.sessionVariable.campaign.campaign_data.length;i++)1==e.sessionVariable.campaign.campaign_data[i].check&&(e.requestData["campid"+o++]=e.sessionVariable.campaign.campaign_data[i].camp_id);if(e.sessionVariable.contact_list.campaign)for(i=0;i<e.sessionVariable.contact_list.campaign.length;i++){var l=e.sessionVariable.contact_list.campaign[i];!e.isCampaignOpen(i)&&e.taggedWithEnquiry(i)&&(e.requestData["campid"+o++]=l.ROW_ID)}n.getDetails(n.getServices().SYNC_RECORDS,e.requestData,e.saveTempEnquiry_callback)}},e.saveTempEnquiry_callback=function(t){if(e.hideLoader(),1==t.success){var i="";e.isExisitingEnquiry?(i="Enquiry has been created successfully",e.isExisitingEnquiry=!1):i="Enquiry has been edited successfully",e.showAlertWindow_Titled("Success",i,e.after_saveTempVehicle)}else e.showAlertWindow_Titled("Error",t.resDescription)},e.after_saveTempVehicle=function(){e.sessionVariable.temp_cont_enq={},e.sessionVariable.selected_enquiry_edit={},e.disableBack(),e.jumpTo("app.dashboard")},e.onChangeCampaign=function(t){var a=e.sessionVariable.campaign.campaign_data[t].check,s=0;for(i=0;i<e.sessionVariable.contact_list.campaign.length;i++){e.sessionVariable.contact_list.campaign[i];!e.isCampaignOpen(i)&&e.taggedWithEnquiry(i)&&s++}for(i=0;i<e.sessionVariable.campaign.campaign_data.length;i++)1==e.sessionVariable.campaign.campaign_data[i].check&&s++;return 4==s&&1==a?(e.sessionVariable.campaign.campaign_data[t].check=!a,void e.showAlertWindow_Titled("oops!","Can't choose more then 3 campaigns")):void 0},e.isCampaignSeleted=function(t){var a=!1,s=e.sessionVariable.campaign.campaign_data[t];if(e.sessionVariable.contact_list.campaign)for(i=0;i<e.sessionVariable.contact_list.campaign.length;i++)e.taggedWithEnquiry(i)&&s.camp_id==e.sessionVariable.contact_list.campaign[i].ROW_ID&&(e.sessionVariable.campaign.campaign_data[t].check=!0,a=!0,e.onChangeCampaign(t));return a},e.isCampaignOpen=function(t){var a=!1,s=e.sessionVariable.contact_list.campaign[t];for(i=0;i<e.sessionVariable.campaign.campaign_data.length;i++)s.ROW_ID==e.sessionVariable.campaign.campaign_data[i].camp_id&&(a=!0);return a},e.taggedWithEnquiry=function(t){var i=!1,a=e.sessionVariable.contact_list.campaign[t];return a.OPTY_ID==e.sessionVariable.selected_enquiry_edit.ENQUIRY_ID&&(i=!0),i},e.onModelChange=function(t,i){var a=t;i||!e.previous_selectedModel?(e.previous_selectedModel=a,e.fetchCampaign(a)):e.showConfirm2("Change model !!","Be careful, changing model will permanantly removed previously added campaigns with this enquiry",a,e.onModelChange_callback,null,null)},e.onModelChange_callback=function(t,i){t?(e.previous_selectedModel=i,e.sessionVariable.contact_list.campaign=[],e.fetchCampaign(i)):e.sessionVariable.temp_cont_enq.X_MODEL_INTERESTED=e.previous_selectedModel}}]);
angular.module("starter.enquiryDetail",[]).controller("enquiryDetailCtrl",["$scope",function(e){e.$on("filterFollowups",function(o,i){"close"==i?e.goBackScreen():"follow"==i?e.$digest():e.$scope.showToast("oops! No action passed ")}),e.editEnquiry=function(){e.sessionVariable.createNewEnquiry=!1,e.sessionVariable.selected_enquiry_edit=e.sessionVariable.selected_enquiry,e.jumpTo("app.editEnquiry")}}]);
...
angular.module("starter.pendingOrderList",[]).controller("pendingOrderListCtrl",["$scope","$ionicPopup","generic_http_post_service","date_picker",function(e,a,r,t){e.arrayList={},e.init=function(){e.find_saved_data()},e.find_saved_data=function(){var a=null;try{a=JSON.parse(e.GetInLocalStorage(e.localStorageKeys.PENDING_ORDERS))}catch(r){}try{a&&(e.arrayList=a),e.Fetch_orders()}catch(r){alert(r)}},e.Fetch_orders=function(){e.dataRefreshing=!0,e.requestData={},e.requestData.user_id=e.sessionVariable.username,e.requestData.dealer_code=e.sessionVariable.login_data.dealer_code,r.getDetails(r.getServices().FETCH_ORDER_DATA,e.requestData,e.Fetch_orders_callback)},e.Fetch_orders_callback=function(a){e.dataRefreshing=!1,1==a.success?(e.SaveInLocalStorage(e.localStorageKeys.PENDING_ORDERS,JSON.stringify(a)),e.arrayList=a):e.showAlertWindow_Titled("Error",a.respDescription,null,null)}}]);
...
angular.module("starter.followupEnquiryModal",[]).controller("followupEnquiryModalCtrl",["$scope","generic_http_post_service","date_picker","$rootScope",function(e,a,t,o){e.page={},e.init=function(){},e.pickDate=function(a){e.page.dateType=a,t.getDate("date",e.pickDate_callback)},e.pickDate_callback=function(a){"exp"==e.page.dateType?e.sessionVariable.selected_enquiry.EXPCTD_DT_PURCHASE=a.currDate:e.page.date=a.currDate},e.getDateWithMonthName=function(e){return t.getDateWithMonthName(e)},e.getFolDateWithMonthName=function(a){if(!a){var o=t.addDays(new Date,3);a=t.convertDateToString(o,"yyyy-mm-dd"),e.page.date=a}},e.followupEnquiry=function(){return e.page.date?(e.showLoader(""),e.requestData={},e.requestData=e.page,e.requestData.fol_date=t.getDateInFormat(e.page.date,"mm/dd/yyyy"),e.requestData.user_id=e.sessionVariable.username,e.requestData.dms_enquiry_id=e.sessionVariable.selected_enquiry.ENQUIRY_ID,void a.getDetails(a.getServices().SYNC_FOLLOW_UP,e.requestData,e.followupEnquiry_callback)):void e.showAlertWindow("Please select date")},e.followupEnquiry_callback=function(a){e.hideLoader(),1==a.success?(e.showAlertWindow_Titled("Success","Next followup scheduled"),e.updateEnquiry(),e.closeModal()):e.showAlertWindow_Titled("Error",a.respDescription,null,null)},e.updateEnquiry=function(){var a=!0,t=0;e.sessionVariable.ten_days_followup&&angular.forEach(e.sessionVariable.ten_days_followup.follow_up,function(r,l){a&&(r.ENQUIRY_ID==e.sessionVariable.selected_enquiry.ENQUIRY_ID&&(e.sessionVariable.ten_days_followup.follow_up[t].FOLLOW_DATE=e.convertFormatOfDate(e.page.date),e.sessionVariable.ten_days_followup.follow_up[t].FOLLOWUP_COMMENTS=e.page.remarks,e.sessionVariable.ten_days_followup.follow_up[t].FOLLOWUP_STATUS="done",e.SaveInLocalStorage(e.localStorageKeys.TEN_DAY_FOLLOW,JSON.stringify(e.sessionVariable.ten_days_followup)),e.getDashboardCounters(),o.$broadcast("filterFollowups","follow"),a=!1),t++)}),a&&(t=0,angular.forEach(e.sessionVariable.contact_list.enquiry,function(r,l){a&&(r.ENQUIRY_ID==e.sessionVariable.selected_enquiry.ENQUIRY_ID&&(e.sessionVariable.contact_list.enquiry[t].FOLLOW_DATE=e.convertFormatOfDate(e.page.date),e.sessionVariable.contact_list.enquiry[t].FOLLOWUP_COMMENTS=e.page.remarks,o.$broadcast("filterFollowups","close"),a=!1),t++)}))},e.convertFormatOfDate=function(e){function a(e){return(""+e).length<2&&(e="0"+e),e}var t="",o=new Array("jan","feb","mar","apr","may","jun","jul","aug","sep","cct","nov","dec"),r=e.split("-"),l=new Date(r[0],parseInt(r[1])-1,r[2]);return t=a(l.getDate())+"-"+o[l.getMonth()]+"-"+l.getFullYear().toString()}}]);
...
angular.module("starter.testride",[]).controller("testrideCtrl",["$scope","$timeout","date_picker","form_validator","generic_http_post_service",function(e,t,s,a,r){e.arrayList={},e.temp_data={},e.init=function(){e.fetch_test_ride()},e.fetch_test_ride=function(){e.showLoader(""),e.requestData={},e.requestData.user_id="1234",e.sessionVariable.selected_enquiry&&(e.requestData.enq_id=e.sessionVariable.selected_enquiry.ENQUIRY_ID),r.getDetails(r.getServices().FETCH_TEST_RIDE,e.requestData,e.fetch_test_ride_callback)},e.fetch_test_ride_callback=function(t){e.hideLoader(),1==t.success?e.arrayList=t:e.showAlertWindow_Titled("Error",t.respDescription,e.goBackScreen,null)},e.submit_test_ride=function(){for(e.showLoader(""),e.requestData={},e.requestData.user_id=e.sessionVariable.username,e.sessionVariable.selected_enquiry&&(e.requestData.enq_id=e.sessionVariable.selected_enquiry.ENQUIRY_ID,e.requestData.dealer_id=e.sessionVariable.selected_enquiry.DEALER_BU_ID),e.requestData.key=e.sessionVariable.testride_key,e.ans={},i=0;i<e.arrayList.test_ride_ques.length;i++)e.temp_data[i+1]&&(e.ans[i+1]=e.temp_data[i+1]);e.requestData.ans=JSON.stringify(e.ans),console.log(JSON.stringify(e.requestData)),r.getDetails(r.getServices().SYNC_TEST_RIDE,e.requestData,e.submit_test_ride_callback)},e.submit_test_ride_callback=function(t){e.hideLoader(),1==t.success?e.showAlertWindow_Titled("Success","Thanks test ride feedaback submited successfully",e.goBackScreen):e.showAlertWindow_Titled("Error",t.respDescription,null,null)}}]);
...
function showMap(e){window.open("http://maps.google.com/?q="+e,"_system")}function launchMail(e){window.location.href="mailto:"+e+"?subject="}function launchCall(e){window.location.href="tel:"+e}function scope_search(){$scope.listScope=angular.element(document.querySelector("[ng-controller=MyDropList]")).scope();var e=angular.element(document.querySelector("#outside")).scope();e.$apply(function(){e.msg="Superhero"})}function getController(e){var r=angular.element(document.querySelector("[ng-controller="+e+"]")).scope();return r}function getJsonKey(e){return Object.keys(e)}function closeKeyboard(){IsMobileDevice()&&cordova.plugins.Keyboard.close()}function IsMobileDevice(){var e=!1;/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)&&(e=!0)}function launchInAppBrowser(e){launchInAppBrowserWithZoom(e)}function launchInAppBrowserWithZoom(e){inAppBrowserbRef=window.open(e,"_blank","EnableViewPortScale=yes")}function inAppBrowserbLoadStart(e){alert(e.type+" - "+e.url),msg="please wait ..";try{spinnerplugin.show()}catch(r){alert("sdds"+r)}}function inAppBrowserbLoadStop(e){alert(e.type+" - "+e.url);try{spinnerplugin.hide()}catch(r){alert("sdds"+r)}}function inAppBrowserbLoadError(e){navigator.notification.activityStop(),alert(e.type+" - "+e.message)}function inAppBrowserbClose(e){alert(e.type),inAppBrowserbRef.removeEventListener("loadstart",inAppBrowserbLoadStart),inAppBrowserbRef.removeEventListener("loadstop",inAppBrowserbLoadStop),inAppBrowserbRef.removeEventListener("loaderror",inAppBrowserbLoadError),inAppBrowserbRef.removeEventListener("exit",inAppBrowserbClose)}function validateEmail(e){var r=/^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$/i;return r.test(e)}function IsValidPhoneNumber(e){var r=/^\+?([0-9]{2})\)?[-. ]?([0-9]{4})[-. ]?([0-9]{4})$/;return!!e.match(r)}function GA_track_screen(e){try{}catch(r){}}function GA_track_event(e,r,o,n){try{OS.IOS?sendEvent("webservice",e,"success",1):sendEvent("webservice",e,r,1)}catch(t){}}function padLeftZero(e){return(""+e).length<2&&(e="0"+e),e}function scrollTop(){$rootScope.scrollTop()}function rc4(e,r){for(var o,n=[],t=0,i="",a=0;256>a;a++)n[a]=a;for(a=0;256>a;a++)t=(t+n[a]+e.charCodeAt(a%e.length))%256,o=n[a],n[a]=n[t],n[t]=o;a=0,t=0;for(var c=0;c<r.length;c++)a=(a+1)%256,t=(t+n[a])%256,o=n[a],n[a]=n[t],n[t]=o,i+=String.fromCharCode(r.charCodeAt(c)^n[(n[a]+n[t])%256]);return i}function randomString(e){for(var r="",o="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",n=0;e>n;n++)r+=o.charAt(Math.floor(Math.random()*o.length));return r}var setLat,setLon,_intentAddAppointment=!1,inAppBrowserbRef;
"use.strict";angular.module("utils.http_post",[]).factory("generic_http_post_service",["$http","$timeout",function(t,e){var _="http://tab.hmcl.biz/",p="dse_app_UAT/",r=Object.freeze({LOGIN:_+p+"login.php",GET_DISTRICT:_+p+"get_district.php",BIKE_MAKE_MODEL:_+p+"bike_make_model.php",GET_DISTRICT_DATA:_+p+"get_district_data.php",GET_STATE_DATA:_+p+"get_state_data.php",LATLONG:_+p+"latlong.php",FETCH_CONTACT:_+p+"fetch_contact.php",SYNC_RECORDS:_+p+"syncRecords.php",SYNC_FOLLOW_UP:_+p+"sync_follow_up.php",GET_FOLLOW_UP:_+p+"get_follow_up.php",CHECK_VERSION:_+p+"check_version.php",FETCH_CAMPAIGN_DATA:_+p+"fetch_campaign_data.php",FETCH_ORDER_DATA:_+p+"fetch_order_data.php",FETCH_TEST_RIDE:_+p+"fetch_test_ride.php",SYNC_TEST_RIDE:_+p+"sync_test_ride.php"}),c={success:0,failure_title:"Error",failure_msg:"Something went wrong",error_code:101},o="punar",i=!1;return{getServices:function(){return r},getDetails:function(e,_,p){i=!0;var r={},o=CryptoJS.AES.encrypt(JSON.stringify(JSON.stringify(_)),"dse",{format:CryptoJSAesJson}).toString();r.data=o,t.post(e,r).success(function(t,e,_,r){i=!1;try{}catch(c){}p(t)}).error(function(t,e,_,r){i=!1,p(c)})},getDetails_httpget:function(e,_,p){i=!0,e+="?",e+="data="+rc4(o,"hello dsc"),t.get(e,{timeout:2e4}).success(function(t,e,_,r){i=!1,p(t)}).error(function(t,e,_,r){i=!1,p(c)})}}}]);
...
angular.module("starter.add_personal_info",[]).controller("add_personal_infoCtrl",["$scope","date_picker","generic_http_post_service","form_validator",function(e,a,o,t){e.data={},e.data.age="dd-mm-yyyy",e.selectedModel="",e.pickDate=function(o){e.selectedModel=o,a.getDate("date",e.pickDate_callback)},e.pickDate_callback=function(a){"age"==e.selectedModel&&(e.data.age=a.currDate)},e.pickTime=function(){a.getDate("time",e.pickTime_callback)},e.getDateWithMonthName=function(e){return a.getDateWithMonthName(e)},e.init=function(){e.showLoader(""),e.sessionVariable.temp_cont_enq.email="";try{e.showLoader("Please wait...");var a=null,o=null,t=null;try{t=JSON.parse(e.GetInLocalStorage(e.localStorageKeys.DISTRICT))}catch(i){console.log("make model not found  "+i),e.hideLoader()}if(t){e.sessionVariable.district_list=t.district,e.sessionVariable.login_data.district_id=e.GetInLocalStorage(e.localStorageKeys.DISTRICT_ID);try{o=JSON.parse(e.GetInLocalStorage(e.localStorageKeys.ALL_DISTRICT)),o&&(e.sessionVariable.tehsil_list=o.tehsil,e.sessionVariable.village_list=o.village)}catch(i){console.log("make model not found  "+i),e.hideLoader()}}else e.get_district(e.sessionVariable.login_data.state_id);try{a=JSON.parse(e.GetInLocalStorage(e.localStorageKeys.MAKE_MODEL))}catch(i){console.log("make model not found  "+i),e.hideLoader()}a?(e.sessionVariable.make_list=a.make,e.sessionVariable.model_list=a.model,e.sessionVariable.model_interested=a.model_interested):e.get_make_model(),e.hideLoader()}catch(i){console.log("make model not found  "+i),e.hideLoader()}},e.onStateChange=function(){e.showConfirm("Are you sure","Do you really want to change your district?",null,e.onStateChange_callback)},e.onStateChange_callback=function(){e.RemoveInLocalStorage(e.localStorageKeys.TEHSIL),e.RemoveInLocalStorage(e.localStorageKeys.VILLAGE),e.RemoveInLocalStorage(e.localStorageKeys.STATE_ID),e.RemoveInLocalStorage(e.localStorageKeys.DISTRICT_ID),e.RemoveInLocalStorage(e.localStorageKeys.TEHSIL_ID),e.sessionVariable.login_data.district_id=void 0,e.sessionVariable.login_data.tehsil_id=void 0;var a=JSON.parse(e.GetInLocalStorage(e.localStorageKeys.STATE));a.state_id=e.sessionVariable.login_data.state_id,e.SaveInLocalStorage(e.localStorageKeys.STATE,JSON.stringify(a)),e.get_district(e.sessionVariable.login_data.state_id.split(",")[0])},e.onDistrictChange=function(){e.showConfirm("Are you sure","Do you really want to change your district?",null,e.onDistrictChange_callback)},e.onDistrictChange_callback=function(){e.SaveInLocalStorage(e.localStorageKeys.DISTRICT_ID,e.sessionVariable.login_data.district_id),e.RemoveInLocalStorage(e.localStorageKeys.VILLAGE),e.RemoveInLocalStorage(e.localStorageKeys.TEHSIL_ID),e.sessionVariable.login_data.tehsil_id=void 0,e.get_full_district_data(e.sessionVariable.login_data.district_id)},e.onTehsilChange=function(){},e.checkNumberLength=function(a){var o=""+e.sessionVariable.temp_cont_enq.age;2==o.length&&a.preventDefault()},e.saveTempPerInfo=function(){return e.sessionVariable.temp_cont_enq.fname?e.sessionVariable.temp_cont_enq.lname?e.sessionVariable.temp_cont_enq.mobile?e.sessionVariable.temp_cont_enq.email&&!t.IsValidEmail(e.sessionVariable.temp_cont_enq.email)?void e.showAlertWindow_Titled("Error","Please enter valid email address"):e.sessionVariable.temp_cont_enq.age?e.sessionVariable.temp_cont_enq.gender?e.sessionVariable.login_data.state_id?e.sessionVariable.login_data.district_id?e.sessionVariable.login_data.tehsil_id?e.sessionVariable.login_data.village_id?void e.jumpTo("app.createEnquiry"):void e.showAlertWindow_Titled("Error","Please select village"):void e.showAlertWindow_Titled("Error","Please select tehsil"):void e.showAlertWindow_Titled("Error","Please select district"):void e.showAlertWindow_Titled("Error","Please select state"):void e.showAlertWindow_Titled("Error","Please select gender"):void e.showAlertWindow_Titled("Error","Please enter age"):void e.showAlertWindow_Titled("Error","Please enter mobile"):void e.showAlertWindow_Titled("Error","Please enter last name"):void e.showAlertWindow_Titled("Error","Please enter first name")}}]);
...
angular.module("starter.createEnquiry",[]).controller("createEnquiryCtrl",["$scope","date_picker","generic_http_post_service","$ionicPopup","$timeout",function(e,a,t,s,n){e.sessionVariable.createEnquiry={},e.init=function(){var a=null;try{a=JSON.parse(e.GetInLocalStorage(e.localStorageKeys.MAKE_MODEL)),a?(e.sessionVariable.make_list=a.make,e.sessionVariable.model_list=a.model,e.sessionVariable.model_interested=a.model_interested):e.get_make_model()}catch(t){console.log("make model not found  "+t),alert(t)}},e.veh_type_list=[{id:1,type:"Two Wheeler"},{id:2,type:"Four wheeler"},{id:3,type:"First Time Buyer"}],e.selectedModel="",e.pickDate=function(t){e.selectedModel=t,a.getDate("date",e.pickDate_callback,!1)},e.pickDate_callback=function(a){"exp"==e.selectedModel?e.sessionVariable.temp_cont_enq.exp_purchase_date=a.currDate:"fol"==e.selectedModel&&(e.sessionVariable.temp_cont_enq.fol_date=a.currDate)},e.pickTime=function(){a.getDate("time",e.pickTime_callback)},e.pickTime_callback=function(a){"folTime"==e.selectedModel&&(e.data.folTime=a.currTime)},e.getDateWithMonthName=function(e){return a.getDateWithMonthName(e)},e.getFolDateWithMonthName=function(t){if(!t){var i=a.addDays(new Date,3);t=a.convertDateToString(i,"yyyy-mm-dd"),e.sessionVariable.temp_cont_enq.fol_date=t}},e.saveTempEnquiry=function(){try{if(e.sessionVariable.selected_enquiry=null,!e.sessionVariable.temp_cont_enq.model_interested)return void e.showAlertWindow_Titled("Error","Please select a model");if(!e.sessionVariable.temp_cont_enq.fol_date)return void e.showAlertWindow_Titled("Error","Please select a followup date");if(!e.sessionVariable.temp_cont_enq.existVeh)return void e.showAlertWindow_Titled("Error","Please select existing vehical type");if(e.sessionVariable.temp_cont_enq.exp_purchase_date){var s=e.sessionVariable.temp_cont_enq.fol_date,n=e.sessionVariable.temp_cont_enq.exp_purchase_date;if(2==a.isGreaterDate(s,n))return void e.showAlertWindow_Titled("Error","Followup date should be smaller then expected purchase date")}1==e.sessionVariable.temp_cont_enq.existVeh,e.showLoader("Please wait..."),e.requestData={},e.requestData=e.sessionVariable.temp_cont_enq,e.requestData.user_id=e.sessionVariable.username,e.sessionVariable.testride_key=randomString(7),e.requestData.key=e.sessionVariable.testride_key,e.requestData.state=e.getValueInJson(e.sessionVariable.state_list,e.sessionVariable.login_data.state_id,"id","state_name"),e.requestData.district=e.getValueInJson(e.sessionVariable.district_list,e.sessionVariable.login_data.district_id,"id","district_name"),e.requestData.tehsil=e.getValueInJson(e.sessionVariable.tehsil_list,e.sessionVariable.login_data.tehsil_id,"id","tehsil_name"),e.requestData.village=e.getValueInJson(e.sessionVariable.village_list,e.sessionVariable.login_data.village_id,"id","village_name"),e.requestData.exchange_req=e.sessionVariable.temp_cont_enq.exchange_req?"Y":"N",e.requestData.finance_req=e.sessionVariable.temp_cont_enq.finance_req?"Y":"N",e.requestData.test_ride=e.sessionVariable.temp_cont_enq.test_ride?"Y":"N",e.requestData.existVeh=e.getValueInJson(e.veh_type_list,e.sessionVariable.temp_cont_enq.existVeh,"id","type"),e.requestData.existMake=e.getValueInJson(e.sessionVariable.make_list,e.sessionVariable.temp_cont_enq.existMake,"id","make_name");var o=e.sessionVariable.temp_cont_enq.fol_date,r=e.sessionVariable.temp_cont_enq.exp_purchase_date;e.requestData.fol_date=a.getDateInFormat(o,"mm/dd/yyyy"),e.requestData.exp_purchase_date=a.getDateInFormat(r,"mm/dd/yyyy"),e.requestData.dealer_code=e.sessionVariable.login_data.dealer_code;var l=1;for(i=0;i<e.sessionVariable.campaign.campaign_data.length;i++)1==e.sessionVariable.campaign.campaign_data[i].check&&(e.requestData["campid"+l++]=e.sessionVariable.campaign.campaign_data[i].camp_id);console.log(JSON.stringify(e.requestData)),t.getDetails(t.getServices().SYNC_RECORDS,e.requestData,e.saveTempEnquiry_callback)}catch(c){alert(c),e.hideLoader()}},e.saveTempEnquiry_callback=function(a){e.hideLoader(),e.sessionVariable.temp_cont_enq.fol_date="",e.sessionVariable.temp_cont_enq.exp_purchase_date="",1==a.success?e.showAlertWindow_Titled("Success","Enquiry has been created successfully",e.after_saveTestRide):e.showAlertWindow_Titled("Error",a.resDescription)},e.after_saveTestRide=function(){var a="Do you like to provide test-ride feedback?";s.confirm({title:"Testride",template:'<div align="center">'+a+"</div>",okType:"button-assertive",cancelType:"button-dark",okText:"Yes",cancelText:"No Thanks"}).then(function(a){e.sessionVariable.temp_cont_enq={},e.jumpTo("app.dashboard"),n(function(){a?e.jumpTo("app.testride"):(console.log("You are not sure"),e.sessionVariable.testride_key=void 0)},200)})},e.after_confirm=function(){},e.onChangeCampaign=function(a){var t=e.sessionVariable.campaign.campaign_data[a].check,s=0;for(i=0;i<e.sessionVariable.campaign.campaign_data.length;i++)1==e.sessionVariable.campaign.campaign_data[i].check&&s++;return 4==s&&1==t?(e.sessionVariable.campaign.campaign_data[a].check=!t,void e.showAlertWindow_Titled("oops!","Can't choose more then 3 campaigns")):void 0}}]);
