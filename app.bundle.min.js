...
angular.module("starter.dashboard",[]).controller("dashboardCtrl",["$scope","generic_http_post_service","fileTransfer","$ionicPlatform",function(o,e,a,t){o.sessionVariable.search={},o.apkPath="",o.directoryPath="",o.HeroProducts_istrat=!0,o.menuList=[{name:"Enquiries",badge:1,icon:"icon ion-ios-list assertive",link:"app.enquiryList"},{name:"Followups",badge:3,icon:"icon ion-chatboxes balanced",link:"app.followupList"},{name:"Contacts",badge:0,icon:"icon ion-android-contacts positive",link:"app.contactList"}],o.init=function(){var e=null;try{e=JSON.parse(o.GetInLocalStorage(o.localStorageKeys.MAKE_MODEL)),e?(o.sessionVariable.make_list=e.make,o.sessionVariable.model_list=e.model,o.sessionVariable.model_interested=e.model_interested):o.get_make_model()}catch(a){console.log("make model not found  "+a)}},o.fetch_contact=function(a){o.showLoader(""),o.requestData={},o.requestData.user_id=o.sessionVariable.username,o.requestData.dealer_code=o.sessionVariable.login_data.dealer_code,o.requestData.phn_no=o.sessionVariable.search.phone?o.sessionVariable.search.phone:"",o.requestData.reg_no=o.sessionVariable.search.regno?o.sessionVariable.search.regno:"",e.getDetails(e.getServices().FETCH_CONTACT,o.requestData,o.fetch_contact_callback)},o.fetch_contact_callback=function(e){o.hideLoader(),o.sessionVariable.temp_cont_enq={},o.sessionVariable.temp_cont_enq.mobile=o.sessionVariable.search.phone,1==e.success?(o.sessionVariable.contact_list=e,o.jumpTo("app.contactList")):0==e.success?(o.showAlertWindow_Titled("Error",e.failure_msg?e.failure_msg:""),o.sessionVariable.contact_list=void 0):(o.sessionVariable.contact_list=void 0,o.jumpTo("app.contactList"))},o.launchProductCatalogApp=function(){o.HeroProducts_istrat?o.checkAppAvailability("com.herocorp"):o.checkAppAvailability("com.ionicframework.gallapp343021")},o.checkAppAvailability=function(e){navigator.startApp.check(e,function(a){o.startApp(e)},function(a){o.downloadApp(e)})},o.startApp=function(e){o.SaveInLocalStorage("Dealer",o.sessionVariable.login_data.dealer_code),navigator.startApp.start(e,function(a){o.OS.ANDROID?navigator.startApp.start([[e],[{dse_id:o.sessionVariable.username}]],function(o){console.log(o)},function(o){console.log(o)}):o.OS.IOS},function(o){})},o.downloadApp=function(e){o.showLoader("Downloading pakage"),o.OS.ANDROID?(o.HeroProducts_istrat?o.apkPath="http://tab.hmcl.biz/HeroProduct/HeroProducts_istrat.apk":o.apkPath="http://tab.hmcl.biz/HeroProduct/HeroProducts.apk",o.directoryPath=cordova.file.externalRootDirectory+"Download/",window.resolveLocalFileSystemURL(o.directoryPath,o.fileDownload())):o.OS.IOS},o.installApk=function(e,a){if(-1==e)alert(JSON.stringify(e)),o.hideLoader(),o.showAlertWindow_Titled("Error",a);else if(-2==e);else{alert("after successfully download "+JSON.stringify(e)),o.hideLoader();var t=e.nativeURL;cordova.plugins.fileOpener2.open(t,"application/vnd.android.package-archive")}},o.fileDownload=function(){var e=new FileTransfer;o.apkPath=encodeURI(o.apkPath),e.onprogress=function(e){try{if(e.lengthComputable){var a=Math.floor(e.loaded/e.total*100),t=a+"% Downloaded...";o.showLoader(t)}else o.showLoader("Downloading...")}catch(i){alert(i)}},e.download(o.apkPath,o.directoryPath+"HeroProducts.apk",function(e){o.installApk()},function(e){o.showAlertWindow_Titled("Sorry","Your download failed."),console.log("download error source "+e.source),console.log("download error target "+e.target),console.log("upload error code"+e.code)},!0,{headers:{Authorization:"Basic dGVzdHVzZXJuYW1lOnRlc3RwYXNzd29yZA=="}}),o.installApk=function(){o.hideLoader(),cordova.plugins.fileOpener2.open(o.directoryPath+"HeroProducts.apk","application/vnd.android.package-archive")}}}]);
